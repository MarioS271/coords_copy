...
abstract class ModPlatformExtension {
	...
	abstract val mainEntrypoint: Property<Boolean>
	abstract val clientEntrypoint: Property<Boolean>
	abstract val datagenEntrypoint: Property<Boolean>
	abstract val modMenuEntrypoint: Property<Boolean>
	...
	init {
		...
		mainEntrypoint.convention(true)
		clientEntrypoint.convention(true)
		datagenEntrypoint.convention(false)
		modMenuEntrypoint.convention(false)
	}
